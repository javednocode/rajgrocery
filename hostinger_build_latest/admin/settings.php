        ...
        <div class="card-body" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
            <div>
                <div class="form-group">
                    ...
                    <input type="email" id="contact_email" class="form-control" placeholder="info@asianfoodcork.ie">
                    <small style="color:#6B7280">Displayed on contact page & used in email links</small>
                </div>
                <div class="form-group">
                    <label>Store Address</label>
                    <textarea id="contact_address" class="form-control" rows="2" placeholder="123 Patrick Street, Cork, Ireland"></textarea>
                    <small style="color:#6B7280">Shown on contact page. Also embedded in LocalBusiness SEO schema.</small>
                </div>
                <div class="form-group">
                    <label>Opening Hours</label>
                    <input type="text" id="contact_hours" class="form-control" placeholder="Mon–Sun: 9am – 9pm">
                    <small style="color:#6B7280">HTML allowed (e.g. Mon–Fri: 9am–6pm&lt;br&gt;Sat–Sun: 10am–5pm)</small>
                </div>
            </div>
            <div>
                <div class="form-group">
                    <label>🗺️ Google Maps Embed URL <span style="color:#c8102e;">*</span></label>
                ...
                <div id="mapPreviewWrap" style="display:none;margin-top:12px;">
                    <label style="font-size:12px;font-weight:700;color:#4B2E83;">Live Preview:</label>
...
const contactFields = ['contact_email','contact_address','contact_hours','contact_map_embed'];
