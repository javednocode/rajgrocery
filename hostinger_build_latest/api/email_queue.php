...
function getEmailLogs($db) {
    ...
    try {
        ...
        // Table probably doesn't exist yet — return empty list gracefully
        successResponse(['data' => [], 'total' => 0, 'message' => 'Run SQL migration to enable logs: ' . $e->getMessage()]);
    }
}
...
function getEmailQueueList($db) {
    ...
    try {
        ...
        successResponse(['data' => [], 'total' => 0, 'message' => 'Run SQL migration to enable queue: ' . $e->getMessage()]);
    }
}
