...
export const routes: Routes = [
  ...
  { path: 'categories', loadComponent: () => import('./features/category/category-list.component').then(m => m.CategoryListComponent) },
  { path: 'category/:slug', loadComponent: () => import('./features/category/category-detail.component').then(m => m.CategoryDetailComponent) },
