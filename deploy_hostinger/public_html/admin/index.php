...
<head>
    ...
    <style>
      ...
      .brand-bar-top span:nth-child(1) { flex: 1; background: #F28C00; }
      ...
      .login-divider span:nth-child(1) { flex: 1; background: #F28C00; }
      ...
      .form-control:focus { border-color: #F28C00; background: white; box-shadow: 0 0 0 3px rgba(242,140,0,0.12); }
      .btn-login {
        width: 100%; padding: 13px;
        background: linear-gradient(135deg, #070A05, #F28C00);
      ...
      #loginAlert.success { background: #EAF4EC; color: #F28C00; border: 1px solid rgba(242,140,0,0.2); display: block; }
...
<div class="login-page">
    <div class="login-box">
        <div class="login-logo">
            <img src="/logo.png" alt="Store logo" onerror="this.style.display='none';this.nextElementSibling.style.display='block'">
