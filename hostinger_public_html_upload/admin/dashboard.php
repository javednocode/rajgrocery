...
<div id="dashboardContent">
    <div class="stat-grid" id="statCards">
        ...
        <div class="stat-card"><div class="stat-icon warning">PR</div><div class="stat-value" id="totalProducts">—</div><div class="stat-label">Products</div></div>
    ...
    <div class="stat-grid" style="grid-template-columns:repeat(3,1fr);">
        ...
        <div class="stat-card"><div class="stat-icon danger">LS</div><div class="stat-value" id="lowStock">—</div><div class="stat-label">Low Stock Items</div></div>
        <div class="stat-card"><div class="stat-icon primary">OS</div><div class="stat-value" id="outOfStock">—</div><div class="stat-label">Out of Stock</div></div>
    </div>
</div>
