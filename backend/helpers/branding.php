...
function brandingDefaults(): array {
    ...
    return [
        'site_name' => [getenv('SITE_NAME') ?: 'Kale Gida', 'text', 'general'],
        ...
        'site_email' => [getenv('SITE_EMAIL') ?: 'hello@kalegida.com', 'text', 'general'],
        ...
        'contact_email' => [getenv('SITE_EMAIL') ?: 'hello@kalegida.com', 'text', 'contact'],
        ...
        'footer_copyright' => ['© ' . date('Y') . ' ' . (getenv('SITE_NAME') ?: 'Kale Gida') . '. All rights reserved.', 'text', 'footer'],
        ...
        'promo_2_label' => ['Turkish bakery', 'text', 'homepage'],
        'promo_2_title' => ['Börek, Künefe & Yufka', 'text', 'homepage'],
        'promo_2_text' => ['Warm bakery and frozen classics, the proper way.', 'textarea', 'homepage'],
        'promo_2_button' => ['Shop Now', 'text', 'homepage'],
        'promo_2_link' => ['/categories', 'text', 'homepage'],
        'promo_2_image' => ['/uploads/promos/turkish-bakery.jpg', 'image', 'homepage'],
        'promo_2_badge' => ['New arrivals', 'text', 'homepage'],
        ...
        'meta_title' => [(getenv('SITE_NAME') ?: 'Kale Gida') . ' — Online Shop', 'text', 'seo'],
        ...
        'smtp_from_email' => [getenv('SITE_EMAIL') ?: 'hello@kalegida.com', 'text', 'email'],
        'smtp_from_name' => [getenv('SITE_NAME') ?: 'Kale Gida', 'text', 'email'],
        'admin_email' => [getenv('SITE_EMAIL') ?: 'hello@kalegida.com', 'text', 'email'],
